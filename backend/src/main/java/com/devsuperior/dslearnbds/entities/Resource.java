...
@Table (name = "tb_resource") //criando tabela
public class Resource implements Serializable{
	...
	@ManyToOne 
	@JoinColumn(name = "offer_id")//mapeando chave estrangeira
	private Offer offer; //para fazer associação    de resource para offer
